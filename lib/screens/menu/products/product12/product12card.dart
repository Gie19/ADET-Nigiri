...
class ProductTwelveCard extends StatefulWidget {
  const ProductTwelveCard({super.key});

  @override
  State<ProductTwelveCard> createState() => _ProductTwelveCardState();
}

class _ProductTwelveCardState extends State<ProductTwelveCard> {
  int quantity = 1;

  // Product details
  final Map<String, dynamic> product = {
    'image': "assets/images/product12.JPG",
    'image2': "assets/images/product12r.png",
    'name': "Kian’s Tofu",
    'price': 180.00,
    'description': "Crispy Tofu Drenched in Spicy Sesame Sauce.",
  };
  @override
