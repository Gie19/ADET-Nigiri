...
class ProductFiveCard extends StatefulWidget {
  const ProductFiveCard({super.key});

  @override
  State<ProductFiveCard> createState() => _ProductFiveCardState();
}

class _ProductFiveCardState extends State<ProductFiveCard> {
  int quantity = 1;

  // Product details
  final Map<String, dynamic> product = {
    'image': "assets/images/product5.JPG",
    'image2': "assets/images/product5r.png",
    'name': "Gyudon Onigiri",
    'price': 230.00,
    'description':
        "Nori, Rice, Spam, Beef Gyudon, Tamago, Furikake And Special Sauce With A Hint Of Wasabi.",
  };
  @override
